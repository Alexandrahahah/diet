 ...
 */
class Style extends \App\Entity\Style implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'musiques' => [parent::class, 'musiques', null],
        "\0".parent::class."\0".'name' => [parent::class, 'name', null],
        'id' => [parent::class, 'id', null],
        'musiques' => [parent::class, 'musiques', null],
