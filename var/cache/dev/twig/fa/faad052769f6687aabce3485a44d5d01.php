...
class __TwigTemplate_6fa5c28538e03e4dcdbcabfb7cbb8527 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 8
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["userForm"]) || array_key_exists("userForm", $context) ? $context["userForm"] : (function () { throw new RuntimeError('Variable "userForm" does not exist.', 8, $this->source); })()), 'widget');
        echo "
...
<button type=\"submit\">Enregistrer</button>
{% endblock %}
", "registration/index.html.twig", "C:\\Users\\CASH\\Desktop\\AFPA\\Symphony\\Blog musique\\templates\\registration\\index.html.twig");
    }
}
